...
const DeleteBug = ({ id, onSuccess }: DeleteBugProps) => {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      showSuccessToast("The Bug was deleted successfully")
      setIsOpen(false)
      onSuccess()
    },
      ...
      <DialogContent className="sm:max-w-md">
        <form onSubmit={handleSubmit(onSubmit)}>
          <DialogHeader>
            ...
            <DialogDescription>
              This Bug will be permanently deleted. Are you sure? You will not
